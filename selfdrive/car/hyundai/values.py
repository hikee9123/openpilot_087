...
class CarControllerParams:
  def __init__(self, CP):
    if CP.carFingerprint in [CAR.GRANDEUR_HEV_19,CAR.SONATA, CAR.PALISADE, CAR.SANTA_FE, CAR.VELOSTER, CAR.GENESIS_G70, CAR.IONIQ_EV_2020, CAR.KIA_CEED, CAR.KIA_SELTOS, CAR.ELANTRA_2021, CAR.ELANTRA_HEV_2021]:
      self.STEER_MAX = 384
    else:
      self.STEER_MAX = 255
...
FEATURES = {
  ...
  "use_elect_gears": set([CAR.GRANDEUR_HEV_19,CAR.KIA_NIRO_EV, CAR.KIA_NIRO_HEV, CAR.KIA_OPTIMA_H, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.IONIQ, CAR.IONIQ_EV_2020, CAR.IONIQ_PHEV, CAR.ELANTRA_HEV_2021]),
...
HYBRID_CAR = set([CAR.GRANDEUR_HEV_19,CAR.IONIQ_PHEV, CAR.ELANTRA_HEV_2021, CAR.KIA_NIRO_HEV])  # these cars use a different gas signal
